 ...
 *
 *  @param accessGroup Provide the keychain access group in which FuturaeKit will store its keychain items.
 *  @param itemsAccessibility Provide the keychain items accessibility which indicates when FuturaeKit keychain items will be accessible.
 *
 *  @return `FTRKeychainConfig` object
 */
